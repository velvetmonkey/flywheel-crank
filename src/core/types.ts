/**
 * Types for flywheel-crank Obsidian plugin
 *
 * Combined from vault-core types and mcp-server read types.
 */
...
// VaultIndex types (from mcp-server read types)
...
export interface FlywheelCrankSettings {
  enableSearch: boolean;
  enableGraphSidebar: boolean;
