...
```bash
cd /home/ben/src/flywheel-crank && npm run build && cp main.js manifest.json styles.css flywheel.png "/mnt/c/Users/benca/obsidian/Ben/.obsidian/plugins/flywheel-crank/"
```
